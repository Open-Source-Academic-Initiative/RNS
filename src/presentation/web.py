...
def _csv_row_for(tender: Tender) -> list[str]:
    return [
        ...
        tender.reference,
        tender.entity,
        tender.ordenentidad or "",
        tender.name,
        tender.description,
        tender.tipo_de_contrato or "",
        tender.unspsc_code or "",
        f"{tender.base_price:.2f}",
        str(tender.duracion or ""),
        tender.unidad_de_duracion or "",
        _serialize_datetime(tender.publish_date),
        _serialize_datetime(tender.last_updated_date),
        ...
        tender.modality or "",
        str(tender.proveedores_invitados or ""),
        str(tender.proveedores_que_manifestaron or ""),
        str(tender.respuestas_al_procedimiento or ""),
        str(tender.proveedores_unicos_con or ""),
        f"{tender.competitive_density_score:.2f}",
